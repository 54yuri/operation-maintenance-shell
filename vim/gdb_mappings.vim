...
function! s:Toggle()
  if s:gdb_k
    ...
    nmap <silent> T :call gdb("bt")<CR>
    nmap <silent> U :call gdb("until")<CR>
	...
	nmap <silent> <C-K> :call <SID>Breakpoint("break")<CR>
    ...
    "if exists("g:vimgdb_debug_pid")
    "    call gdb("attach " . g:vimgdb_debug_pid)
    "endif
...
"" put in  /usr/share/vim/vim72/macros/gdb_mappings.vim
